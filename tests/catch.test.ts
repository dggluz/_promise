...
_pStringBoolean.catch(_ => { // $ExpectType _Promise<string | number, unknownError>
    return 3;
});
...
_pStringBoolean.catch(_ => { // $ExpectType _Promise<string, unknownError>
...
_pStringBoolean.catch(_ => { // $ExpectType _Promise<string | number, string | unknownError>
